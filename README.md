...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/thepipe-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13986&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/thepipe-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `thepipe` can be installed with:

```
conda install thepipe
```

It is possible to list all of the versions of `thepipe` available on your platform with:
